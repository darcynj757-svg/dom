...
export default function Services() {
  useSeo({
    ...
    description: "Строительство домов из профилированного бруса и рубленых домов из бревна в Томске. Кедр Томск — под ключ с 2001 года. Бесплатный проект при заказе.",
  });
      ...
      <section ref={heroRef} className="py-20 md:py-28 border-b border-border overflow-hidden">
        <div className="container mx-auto px-4 md:px-6">
          ...
          >
            ...
            <h1 className="mt-3 font-serif text-2xl md:text-4xl lg:text-5xl font-medium">
